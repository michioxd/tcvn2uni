...
Vì đây là công cụ được xử lý 100% bằng trình duyệt không thông qua máy chủ, nên các định dạng file Word và PowerPoint cũ như .doc và .ppt đều cần được chuyển đổi qua định dạng .docx cho file Word và .pptx cho file PowerPoint.

## Cách sử dụng

- Bước 1: Lựa chọn tệp (.docx hoặc .pptx)
